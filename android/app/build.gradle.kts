...
val flutterVersionName = localProperties.getProperty("flutter.versionName") ?: "1.2.0"
val flutterVersionCode = localProperties.getProperty("flutter.versionCode")?.toInt() ?: 120
