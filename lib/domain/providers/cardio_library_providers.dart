...
final cardioSessionTemplatesProvider = FutureProvider<List<CardioSessionTemplate>>((ref) {
...
final cardioSessionTemplatesBySportProvider = FutureProvider.autoDispose.family<List<CardioSessionTemplate>, Sport>((
  ref,
  sport,
) {
