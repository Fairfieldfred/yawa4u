...
SkinModel _$SkinModelFromJson(Map<String, dynamic> json) => SkinModel(
  ...
  lightMode: SkinModeColors.fromJson(json['lightMode'] as Map<String, dynamic>),
  darkMode: SkinModeColors.fromJson(json['darkMode'] as Map<String, dynamic>),
  ...
  components: SkinComponents.fromJson(
    json['components'] as Map<String, dynamic>,
  ),
  backgrounds: json['backgrounds'] == null
      ? null
      : SkinBackgrounds.fromJson(json['backgrounds'] as Map<String, dynamic>),
);
...
SkinBackgrounds _$SkinBackgroundsFromJson(
  ...
  lightOverlayOpacity: (json['lightOverlayOpacity'] as num?)?.toDouble() ?? 0.7,
