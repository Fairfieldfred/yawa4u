...
mixin _$ExerciseFeedbackDaoMixin on DatabaseAccessor<AppDatabase> {
  ...
  $ExerciseFeedbacksTable get exerciseFeedbacks => attachedDatabase.exerciseFeedbacks;
...
class ExerciseFeedbackDaoManager {
  ...
  $$ExerciseFeedbacksTableTableManager get exerciseFeedbacks => $$ExerciseFeedbacksTableTableManager(
