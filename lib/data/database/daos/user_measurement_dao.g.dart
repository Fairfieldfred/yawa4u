...
mixin _$UserMeasurementDaoMixin on DatabaseAccessor<AppDatabase> {
  $UserMeasurementsTable get userMeasurements => attachedDatabase.userMeasurements;
...
class UserMeasurementDaoManager {
  ...
  $$UserMeasurementsTableTableManager get userMeasurements => $$UserMeasurementsTableTableManager(
