...
final class $$TrainingCyclesTableReferences
  ...
  static MultiTypedResultKey<$SessionsTable, List<Session>> _sessionsRefsTable(
    ...
    db.sessions,
    aliasName: 'training_cycles__uuid__sessions__training_cycle_uuid',
  );
  ...
  _cyclePeriodsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.cyclePeriods,
    aliasName: 'training_cycles__uuid__cycle_periods__training_cycle_uuid',
  );
...
final class $$ExercisesTableReferences
  ...
  _exerciseSetsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.exerciseSets,
    aliasName: 'exercises__uuid__exercise_sets__exercise_uuid',
  );
  ...
  _exerciseFeedbacksRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        ...
        aliasName: 'exercises__uuid__exercise_feedbacks__exercise_uuid',
      );
...
final class $$ExerciseSetsTableReferences
  ...
  static $ExercisesTable _exerciseUuidTable(_$AppDatabase db) =>
      db.exercises.createAlias('exercise_sets__exercise_uuid__exercises__uuid');
...
final class $$ExerciseFeedbacksTableReferences
  ...
  static $ExercisesTable _exerciseUuidTable(_$AppDatabase db) => db.exercises
      .createAlias('exercise_feedbacks__exercise_uuid__exercises__uuid');
...
final class $$SessionsTableReferences
  ...
  static $TrainingCyclesTable _trainingCycleUuidTable(_$AppDatabase db) => db
      .trainingCycles
      .createAlias('sessions__training_cycle_uuid__training_cycles__uuid');
  ...
  _sessionCardioRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.sessionCardio,
    aliasName: 'sessions__uuid__session_cardio__session_uuid',
  );
  ...
  _sessionIntervalsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.sessionIntervals,
    aliasName: 'sessions__uuid__session_intervals__session_uuid',
  );
  ...
  _sessionSamplesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.sessionSamples,
    aliasName: 'sessions__uuid__session_samples__session_uuid',
  );
  ...
  _cardioFeedbackRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.cardioFeedback,
    aliasName: 'sessions__uuid__cardio_feedback__session_uuid',
  );
...
final class $$CyclePeriodsTableReferences
  ...
  static $TrainingCyclesTable _trainingCycleUuidTable(_$AppDatabase db) => db
      .trainingCycles
      .createAlias('cycle_periods__training_cycle_uuid__training_cycles__uuid');
...
final class $$SessionCardioTableReferences
  ...
  static $SessionsTable _sessionUuidTable(_$AppDatabase db) =>
      db.sessions.createAlias('session_cardio__session_uuid__sessions__uuid');
...
final class $$SessionIntervalsTableReferences
  ...
  static $SessionsTable _sessionUuidTable(_$AppDatabase db) => db.sessions
      .createAlias('session_intervals__session_uuid__sessions__uuid');
...
final class $$SessionSamplesTableReferences
  ...
  static $SessionsTable _sessionUuidTable(_$AppDatabase db) =>
      db.sessions.createAlias('session_samples__session_uuid__sessions__uuid');
...
final class $$CardioFeedbackTableReferences
  ...
  static $SessionsTable _sessionUuidTable(_$AppDatabase db) =>
      db.sessions.createAlias('cardio_feedback__session_uuid__sessions__uuid');
