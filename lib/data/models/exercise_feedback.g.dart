...
ExerciseFeedback _$ExerciseFeedbackFromJson(Map<String, dynamic> json) => ExerciseFeedback(
  ...
  muscleGroupSoreness: (json['muscleGroupSoreness'] as Map<String, dynamic>?)?.map(
    (k, e) => MapEntry(k, $enumDecode(_$SorenessEnumMap, e)),
  ),
  timestamp: json['timestamp'] == null ? null : DateTime.parse(json['timestamp'] as String),
);

Map<String, dynamic> _$ExerciseFeedbackToJson(ExerciseFeedback instance) => <String, dynamic>{
